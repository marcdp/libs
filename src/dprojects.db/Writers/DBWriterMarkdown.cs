...
namespace DProjects.Db.Writers {
    ...
    public class DBWriterMarkdown : IDBWriter {
        ...
        //constructor
        public DBWriterMarkdown(TextWriter writer, bool leaveOpen, Settings settings) {
            mWriter = writer;
        ...
        public DBWriterMarkdown(TextWriter writer, bool leaveOpen) : this(writer, leaveOpen, new Settings()) {
        }
        public void Dispose() {
            WriteTable();
            mWriter.Flush();

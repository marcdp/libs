...
namespace DProjects.Fs.Aws {
    ...
    public class FilesystemS3Buckets : FilesystemAsync {
        ...
        //constructor
        public FilesystemS3Buckets(string bucket, string region, string accessKeyId, string secretAccesKey, string basePath, bool autoGzip, bool autoCache, bool isReadOnly, long uploadPartSize) : base(isReadOnly) {
            mBucket = bucket;
            mRegion= region;

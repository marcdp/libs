...
namespace DProjects.Fs.Aws {
    ...
    public class FilesystemS3BuckcetsFactory : IFactoryByUrl<IFilesystem> {
        ...
        public IFilesystem Create(string src) {
            ...
            return new FilesystemS3Buckets(bucket, region, accessKeyId, secretAccesKey, basePath, autoGzip, autoCache, isReadonly, uploadPartSize);
        }
